package com.example.cardsmicroservice.controller;
...
import com.example.cardsmicroservice.dto.ErrorResponseDto;
import com.example.cardsmicroservice.dto.ResponseDto;
...
@Tag(
        name = "CRUD REST APIs for Cards in SBank",
        description = "CRUD REST APIs in SBANK to CREATE, UPDATE, FETCH AND DELETE card details"
)
@RestController
...
public class CardsController {
    ...
    @Operation(
            ...
            description = "REST API to create new Card inside SBANK"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
